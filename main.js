function startClassification()
{
    ...
    classifier = ml5.soundClassifier('https://teachablemachine.withgoogle.com/models/y-ux9YaUz/model.json', modelReady);
}
...
function gotResults(error, results) {
    if (error) {
        ...
        } else if (results[0].label == "Sharpie hitting canvas") {
